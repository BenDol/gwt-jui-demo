...
public class SortablePresenter extends Presenter<SortablePresenter.MyView, SortablePresenter.MyProxy>
        implements SortableUiHandlers {
    interface MyView extends View, HasUiHandlers<SortableUiHandlers> {
    }

    @NameToken(NameTokens.sortable)
    @ProxyCodeSplit
    interface MyProxy extends ProxyPlace<SortablePresenter> {
    }
